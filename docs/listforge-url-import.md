...
3. Auto-opens `MobileListForgeImporter` with `initialData` prop
4. Importer skips upload step and auto-advances to review
...
3. Auto-opens the import modal with ListForge tab active
4. `ListForgeTab` receives `initialData` prop, skips upload, auto-advances to review
