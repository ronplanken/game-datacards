...
- Never add tooling or assistant attribution to PR titles, PR descriptions, or
  comments. Do not append a "Generated by Claude Code" footer (or any similar
  generated-by line or link) to a PR body or comment, and do not add
  `Co-Authored-By:` or `Claude-Session:` trailers to commits
