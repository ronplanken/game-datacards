...
import { VERSION_CONFIG } from "../v3.4.1";

describe("Desktop WhatsNewWizard v3.4.1 config", () => {
  it("has version 3.4.1", () => {
    expect(VERSION_CONFIG.version).toBe("3.4.1");
  });

  it("has the correct release name", () => {
    expect(VERSION_CONFIG.releaseName).toBe("AoS Custom Templates");
  });
