...
import { VERSION_CONFIG } from "../v3.2.1";

describe("Desktop WhatsNewWizard v3.2.1 config", () => {
  it("has version 3.2.1", () => {
    expect(VERSION_CONFIG.version).toBe("3.2.1");
  });

  it("has the correct release name", () => {
    expect(VERSION_CONFIG.releaseName).toBe("UI Improvements");
  });
