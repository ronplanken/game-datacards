...
import { VERSION_CONFIG } from "../v3.4.0";

describe("Desktop WhatsNewWizard v3.4.0 config", () => {
  it("has version 3.4.0", () => {
    expect(VERSION_CONFIG.version).toBe("3.4.0");
  });

  it("has the correct release name", () => {
    expect(VERSION_CONFIG.releaseName).toBe("Card Designer Beta");
  });
