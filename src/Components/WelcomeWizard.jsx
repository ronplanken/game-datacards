...
export const WelcomeWizard = () => {
  ...
  const endWizard = () => {
    ...
    setStep(0);
    updateSettings({ ...settings, wizardCompleted: process.env.REACT_APP_VERSION });
  };
      ...
      {isWizardVisible && (
        <div className='welcome-background'>
          <div className='welcome-container'>
            <div style={{ backgroundColor: '#001529', width: '100%', height: '90px', textAlign: 'center' }}>
              <h1 style={{ height: '100%', lineHeight: '90px', fontSize: '32px', color: 'white' }}>
                {step === 0 && 'Welcome'}
                  ...
                  <Row style={{ padding: '16px' }}>
                    <Col span={12}>
                      ...
                      <Typography.Paragraph style={{ fontSize: '15px' }}>
                        ...
                        treeview. We will try to help remind you if you have any unsaved changes, but closing the browser will
                        not save the card!
                      </Typography.Paragraph>
                    </Col>
                    <Col span={10} push={1}>
                  ...
                  <Row style={{ padding: '16px' }}>
                    <Col span={12}>
                      <Typography.Paragraph style={{ fontSize: '16px' }}>
                        ...
                        Share button in the top right. <Image src={wizard05} preview={false} style={{ height: "48px"}} />
                      </Typography.Paragraph>
                      <Typography.Paragraph style={{ fontSize: '16px' }}>
                        The generated link is perfect to share with your friends or to view on your mobile device. This way you can even take your cards with you on the move and use them digitally during a game!
                      </Typography.Paragraph>
                    </Col>
                    <Col span={10} push={1}>
                  ...
                  <Row style={{ paddingTop: '8px' }} justify={'center'}>
                    <Col span={16}>
                      <Card
                        type={'inner'}
                        title={'Basic Cards'}
                        bodyStyle={{ padding: 0, borderBottom: '1px solid #001529' }}
                        style={{ marginBottom: '16px', border: '1px solid #001529', borderBottom: '0px' }}
                        extra={
                          <Switch
                            onChange={() =>
                    ...
                    <Col span={16}>
                      <Card
                        ...
                        extra={
                          <Switch
                            onChange={() => updateSettings({ ...settings, selectedDataSource: '40k' })}
