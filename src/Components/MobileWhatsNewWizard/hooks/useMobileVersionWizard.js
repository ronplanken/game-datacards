...
/**
 * useMobileVersionWizard - Hook for managing mobile version wizard state and logic
 *
...
export const useMobileVersionWizard = () => {
  ...
  const unseenVersions = useMemo(() => {
    return getMobileUnseenVersions(settings.lastMajorWizardVersion, currentVersion);
...
export default useMobileVersionWizard;
