...
import { MOBILE_VERSION_CONFIG } from "../v3.5.2";

describe("Mobile WhatsNewWizard v3.5.2 config", () => {
  it("has version 3.5.2", () => {
    expect(MOBILE_VERSION_CONFIG.version).toBe("3.5.2");
  });

  it("has the correct release name", () => {
    expect(MOBILE_VERSION_CONFIG.releaseName).toBe("Image Export Fixes");
  });
