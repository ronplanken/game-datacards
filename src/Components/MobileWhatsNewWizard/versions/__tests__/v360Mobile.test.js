...
import { MOBILE_VERSION_CONFIG } from "../v3.6.0";

describe("Mobile WhatsNewWizard v3.6.0 config", () => {
  it("has version 3.6.0", () => {
    expect(MOBILE_VERSION_CONFIG.version).toBe("3.6.0");
  });

  it("has the correct release name", () => {
    expect(MOBILE_VERSION_CONFIG.releaseName).toBe("Premium Accounts");
  });
