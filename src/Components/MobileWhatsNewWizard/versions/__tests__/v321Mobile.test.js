...
import { MOBILE_VERSION_CONFIG } from "../v3.2.1";

describe("Mobile WhatsNewWizard v3.2.1 config", () => {
  it("has version 3.2.1", () => {
    expect(MOBILE_VERSION_CONFIG.version).toBe("3.2.1");
  });

  it("has the correct release name", () => {
    expect(MOBILE_VERSION_CONFIG.releaseName).toBe("UI Improvements");
  });
