...
/**
 * StepThankYou - Thank you / closing step for mobile v3.2.0
 *
...
export const StepThankYou = () => (
  <div className="mwnw-thankyou">
    ...
    <p className="mwnw-thankyou-text">
      Thank you for using Game Datacards. Subscribe anytime from Settings if you need more storage. Join our Discord for
      updates!
    </p>
