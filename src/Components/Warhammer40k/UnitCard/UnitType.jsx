    ...
    case "Heavy Support":
      return (
        <div
          ...
          title="Heavy Support"
          alt-text="Heavy Support"
        />
      );
    case "Fast Attack":
      return (
        <div
          className="fast-attack"
          title="Fast Attack"
          alt-text="Fast Attack"
        />
      );
    case "Dedicated Transport":
      return (
        <div
          className="dedicated-transport"
          title="Dedicated Transport"
          alt-text="Dedicated Transport"
        />
      );
    case "Flyers":
    ...
    case "Fortifications":
      return (
        <div
          ...
          alt-text="Fortifications"
        />
      );
    case "Lords of War":
      return (
        <div
          className="lord-of-war"
          title="Lords of War"
          alt-text="Lords of War"
        />
      );
    default:
