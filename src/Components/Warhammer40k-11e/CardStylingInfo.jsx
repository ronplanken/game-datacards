...
/**
 * Shared card styling component for the 11e Enhancement and Stratagem editors.
 *
 * Both card types share identical styling options: width, height, text size and
 * line height. The values are plain numbers (no localisation), matching the
 * renderers which read `card.styling?.*` directly.
 *
 * @param {Object} props
