...
function DesignerToolbar({ zoom, showGrid, onZoomChange, onToggleGrid, onUndo, onRedo, canUndo, canRedo }) {
  return (
    <div className="designer-toolbar">
      ...
      <div className="designer-toolbar-section designer-toolbar-controls">
        ...
        <div className="toolbar-group">
          <button className="toolbar-button" onClick={onUndo} disabled={!canUndo} title="Undo (Ctrl+Z)">
            ↶ Undo
          </button>
          <button className="toolbar-button" onClick={onRedo} disabled={!canRedo} title="Redo (Ctrl+Y)">
            ↷ Redo
          </button>
        </div>
        ...
        <div className="toolbar-group">
          ...
          <select className="toolbar-select" value={zoom} onChange={(e) => onZoomChange(parseFloat(e.target.value))}>
        ...
        <div className="toolbar-group">
          <label className="toolbar-checkbox-label">
            <input type="checkbox" checked={showGrid} onChange={onToggleGrid} className="toolbar-checkbox" />
            Show Grid
          </label>
        </div>
      </div>
