...
import { FolderOutlined, ExclamationCircleOutlined, DeleteOutlined } from '@ant-design/icons';
import { useCardStorage } from '../Hooks/useCardStorage';
import { Dropdown, Input, Menu, message, Modal } from 'antd';

const { confirm } = Modal;

export function TreeCategory({ category, selectedTreeIndex, setSelectedTreeIndex }) {
  const { cardStorage, setActiveCard, setActiveCategory, removeCategory, renameCategory, cardUpdated } =
    useCardStorage();
