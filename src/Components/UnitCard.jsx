        ...
        <div className="frame">
          ...
          {unit.datasheet?.filter((sheet) => sheet.active).length > 0 && (
            <div className="labels heading">
              ...
              <div className="center label">
                <div
                  className="weaponskill icon"
                  title="Weapon Skill"
                  alt-text="Weapon Skill"
                ></div>
              </div>
              <div className="center label">
                <div
            ...
            {unit.abilities?.map((ability, index) => {
              return (
                ability.showAbility && (
                  <div
                    className="description"
                    key={`ability-${ability.name}-description-${index}`}
                  >
