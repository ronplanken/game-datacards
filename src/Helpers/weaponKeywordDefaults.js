/**
 * Default weapon keyword glossary entries seeded into new `40k-10e` datasources.
 *
 ...
 * `schema.weaponKeywordGlossary` array; this list is the starter set.
 *
 * matchType:
 *   - "exact"  — case-insensitive equality against the weapon's keyword tag
 *   - "prefix" — case-insensitive startsWith match against the keyword tag,
 *                used for parametrised rules ("Anti-Infantry 4+", "Melta 2", …)
 *
 * The renderer resolves a weapon keyword to at most one glossary entry by
 ...
 */
export const WARHAMMER_40K_10E_WEAPON_KEYWORDS = [
  {
    key: "anti",
    name: "Anti-",
