...
const svgIcon = () => (
  <svg width="1em" height="1em" viewBox="0 0 334 471" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      fill="currentColor"
    />
    <path d="M97 244H129V341H97V244Z" fill="currentColor" />
    <path d="M97 373H129V470H97V373Z" fill="currentColor" />
    <path d="M0 373V341H97H129H225V373H129H97H0Z" fill="currentColor" />
  </svg>
);
